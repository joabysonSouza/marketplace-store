...
import { Key, Loader, Trash2 } from "lucide-react";
  ...
  return (
    <section className="container flex flex-col my-2 space-y-2">
      {cartDetails &&
          ...
          <Card key={key}>
            ...
            <CardContent className="grid gap-6">
              <div className="flex items-center justify-between space-x-4">
                ...
                <Trash2 className="text-red-400 hover:text-red-600 cursor-pointer" onClick={() => removeItem(key)} />
              </div>
            </CardContent>
          </Card>
        ))}
       ...
       {
        cartCount === 0 ? <h1>Não á itens no carrinho adicione na Marketplace store</h1> : ""
       }
        </div>
      <div
        className={cn(
